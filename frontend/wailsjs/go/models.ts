export namespace apptypes {
	...
	export class ShellMatch {
	    variable: string;
	    line: number;
	
	    static createFrom(source: any = {}) {
	        return new ShellMatch(source);
	    }
	...
	export class ShellConflict {
	    ...
	    static createFrom(source: any = {}) {
	        return new ShellConflict(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.label = source["label"];
	        this.path = source["path"];
	        this.matches = this.convertValues(source["matches"], ShellMatch);
	    }
	...
	export class ConfigStatus {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.shell_conflicts = this.convertValues(source["shell_conflicts"], ShellConflict);
	    }
